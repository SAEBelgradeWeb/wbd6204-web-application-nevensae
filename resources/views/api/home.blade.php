            ...
            <div class="h-96 w-1/4 bg-blue-500 inline-block">
                <nav>
                    <ul class="mt-32 text-white text-center">
                        <li class="m-2 hover:bg-blue-700 block"><a href="#">Dashboard</a></li>
                        <li class="m-2 hover:bg-blue-700 block"><a href="#">Contests</a></li>
                        <li class="m-2 hover:bg-blue-700 block"><a href="#">Users</a></li>
            ...
            <div class="w-4/5">
                <table class="rounded-t-lg m-5 w-5/6 mx-auto bg-gray-200 text-gray-800">
                        ...
                        <tr >
                            ...
                            <td class="px-4 py-3">smitthy@gmail.com</td>

                            <td class="px-2 py-3"><a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="#">Create</a></td>
